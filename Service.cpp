...
public:
    ...
    void hotels()
    {
        string hotelNo[] = {"Brahmaputra", "Dihing", "Disang"};
        for(int a = 0; a < 3; a++)
        {
        ...
        if(choiceHotel == 1){
            ...
            cout << "\tLive a Luxury at BRAHMAPUTRA: Rs.15000.00" << endl;
            ...
            if (packChoice1 == 1){
                cout<<"\n for how many days you stay here ?"<<endl;
                cin>>days;
                hotelCost = 5000.00*days;
                cout << "\nYou have successfully booked Standard Pack at BRAHMAPUTRA" << endl;
                ...
                cout << "\nYou have successfully booked Premium Pack at BRAHMAPUTRA" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
                ...
                cout << "\nYou have successfully booked Luxury Pack at BRAHMAPUTRA" << endl;
                cout << "Goto Menu to take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            if (packChoice1 == 1){
                ...
                cin>>days;
                hotelCost = 15000.00*days;
                cout << "You have successfully booked Family Pack at DIHING" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                cout<<"\n for how many days you stay here ?"<<endl;
                cin>>days;
                hotelCost = 10000.00*days;
                cout << "You have successfully booked Couple Pack at DIHING" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                cout<<"\n for how many days you stay here ?"<<endl;
                cin>>days;
                hotelCost = 5000.00*days;
                cout << "You have successfully booked Single Pack at DIHING" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            cout << "-------WELCOME TO HOTEL DISANG-------\n" << endl;
            cout << "Set in tropical gardens on the banks of the  river While Seeing Elephants" << endl;
            ...
            if (packChoice1 == 1){
                ...
                cin>>days;
                hotelCost = 5000.00*days;
                cout << "You have successfully booked DISANG Special Pack" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
...
public:
    ...
    void printBill()
    {
        ...
        {
            outf << "--------Agrawal Travel Agency--------" << endl;
            outf << "-------------Receipt-------------" << endl;
